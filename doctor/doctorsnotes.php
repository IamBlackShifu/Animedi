...
<div class="sidebar" id="sidebar">
    <div class="p-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link active" href="doctorsnotes.php"><i class="fas fa-sticky-note me-2"></i><span>Doctor Notes</span></a></li>
...
<nav class="navbar navbar-expand-lg navbar-dark" id="navbar">
    <div class="container-fluid">
        ...
        <h3 class="navbar-brand mb-0">Doctor Notes - Dr. <?php echo $_SESSION['user_name']; ?></h3>
    </div>
</nav>
